        ...
        return (
            <div className="App">
                ...
                <div className="faq">
                    ...
                    <h4 className="faq-intro">The Game of Life is a cellular automaton created by the British mathematician John Horton Conway in 1970. The game is simple but can produce astounding algorithmic creations that simulate the growth of life forms in an entirely synthetic enviroment.</h4>
